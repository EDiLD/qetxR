...
opts_chunk$set(fig.align='center', par=TRUE, warning=FALSE, message=FALSE, 
               error=FALSE, cache=TRUE, dev='tikz', fig.width=5, fig.height=5, fig.show='hold',
               figadj=TRUE)
...
<<preface, child='chapters/preface.Rnw', eval=TRUE, fig.path='graphics/'>>=
@
