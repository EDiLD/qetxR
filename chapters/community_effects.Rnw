...
This create a data.frame with two columns (\verb|left| and \verb|right|) specifying the interval of the EC50 values for each species:
...
The following code produces figure \ref{fig:ssd_res}:\todo{caption}
