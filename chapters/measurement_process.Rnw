...
The Winsorized mean $(\bar{x}_w)$ now is \Sexpr{round(mw, 2)} mg/L, the standard 
deviation of the modified data set (s) is \Sexpr{round(sw, 2)} mg/L and the 
Winsorized standard deviation $(s_w)$ \Sexpr{round(sdw, 2)} mg/L.
