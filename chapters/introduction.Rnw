...
The package contains all datasets that will be used through this book, moreover it brings some convenience functions. Most datasets are from the real world, however all of them are already 'cleaned'
